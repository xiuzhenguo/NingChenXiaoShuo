...
+ (void)setupNavigationBarTheme {
    ...
    att[NSForegroundColorAttributeName] = BXColor(40, 40, 40);
...
//        viewController.hidesBottomBarWhenPushed = YES;
        ...
        //设置导航栏的按钮
       UIBarButtonItem *backButton = [UIBarButtonItem itemWithImageName:@"" highImageName:@"返回" target:self action:@selector(back)];
