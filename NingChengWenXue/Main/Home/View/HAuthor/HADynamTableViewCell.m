...
@implementation HADynamTableViewCell
...
- (void)setViewModel:(WriterDynModel *)viewModel{
    ...
    self.titleLab.text = viewModel.Fiction.FictionName;
    
    self.writorLab.frame = CGRectMake(113, CGRectGetMaxY(self.titleLab.frame)+4, BXScreenW - 133, 15);
    self.writorLab.text = [NSString stringWithFormat:@"著:%@",viewModel.Fiction.AuthorName];
    
    self.numLab.frame = CGRectMake(113, CGRectGetMaxY(self.writorLab.frame)+4, BXScreenW - 133, 15);
//    NSString *ReadCount = [NSString stringWithFormat:@"%@",viewModel.Fiction.ReadCount];
//    NSString *PostCount = [NSString stringWithFormat:@"%@",viewModel.Fiction.ReadCount];
//    NSString *ReadCount = [NSString stringWithFormat:@"%@",viewModel.Fiction.ReadCount];
    self.numLab.text = [NSString stringWithFormat:@"%@/%@/%@",viewModel.Fiction.ReadCount,viewModel.Fiction.PostCount,viewModel.Fiction.CollectCount];
