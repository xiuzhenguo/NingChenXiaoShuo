...
@implementation HAllComListTableViewCell
...
- (void)setViewModel:(ShuPingListModel *)viewModel{
    ...
    [self.imgView sd_setImageWithURL:[NSURL URLWithString:viewModel.UserHeadImage] placeholderImage:[UIImage imageNamed:@"作者头像"]];
