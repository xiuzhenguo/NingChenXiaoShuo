//
//  HSchSearchViewController.m
//  NingChengWenXue
//
//  Created by 云彩 on 17/3/13.
...
@interface HSchSearchViewController ()<UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate>
...
@implementation HSchSearchViewController
...
-(void) getSearchData:(NSString *) searchText {
    ...
    [self.helper communitySearchWithInputstring:searchText pageIndex:[NSString stringWithFormat:@"%ld",self.pagenum] success:^(NSArray *response) {
