...
@interface HAutWriteViewController ()<UITextViewDelegate>
...
@implementation HAutWriteViewController
...
-(void) uploadNovelReview {
    ...
    [self.helper AddleacveYanWithUserId:self.authorId LeaveUserId:kUserID Content:self.textView.text success:^(NSDictionary *response) {
