    ...
    [self.helper addShuPingWithFictionId:self.bookID UserId:kUserID SectionId:self.secID Content:self.textView.text success:^(NSDictionary *response) {
        st_dispatch_async_main(^{
            ...
            if (model.StatusCode == 200) {
                ...
                NSDictionary *dic = @{@"PostClass":@1,@"SectionIndex":@(weakSelf.SectionIndex),@"IsApplaud":@0,@"Content":weakSelf.textView.text,@"SectionName":weakSelf.SectionName,@"Id":model.datas,@"AuthorName":@"",@"UserHeadImage":@"",@"Time":@"1秒前",@"Reply":@0,@"Applaud":@0};
