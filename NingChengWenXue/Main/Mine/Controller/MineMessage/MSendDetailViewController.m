...
@interface MSendDetailViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MSendDetailViewController
...
-(void)getSendMessageDetailData {
    ...
    [self.helper sendMessageDetailWithMsgId:self.msgId success:^(NSDictionary *response) {
        ...
        st_dispatch_async_main(^{
            ...
            [self.dataArray addObject:model.RecevieUserName];
            [self.dataArray addObject:model.Title];
            [self.dataArray addObject:model.SendTime];
