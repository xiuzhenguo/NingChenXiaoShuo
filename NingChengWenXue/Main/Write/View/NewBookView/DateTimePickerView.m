...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        UIView *contentV = [[UIView alloc] initWithFrame:CGRectMake(0, BXScreenH, BXScreenW, 220)];
        ...
        [cancelButton setTitleColor:BXColor(236,105,65) forState:UIControlStateNormal];
        ...
        [chooseButton setTitleColor:BXColor(236,105,65) forState:UIControlStateNormal];
        ...
        self.titleL = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(cancelButton.frame), 0, BXScreenW-104, 40)];
        [upVeiw addSubview:_titleL];
        _titleL.textColor = BXColor(152, 152, 152);
        ...
        splitView.backgroundColor = BXColor(195, 195, 195);
...
{
    UILabel*label=[[UILabel alloc]initWithFrame:CGRectMake(BXScreenW*component/6.0, 0,BXScreenW/6.0, 30)];
...
- (void)showDateTimePickerView{
    [self setCurrentDate:[NSDate date]];
    self.frame = CGRectMake(0, 0, BXScreenW, BXScreenH);
    [UIView animateWithDuration:0.25f animations:^{
        self.alpha = 1;
        _contentV.frame = CGRectMake(0, BXScreenH-220, BXScreenW, 220);
...
- (void)hideDateTimePickerView{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        self.alpha = 0;
        _contentV.frame = CGRectMake(0, BXScreenH, BXScreenW, 220);
    } completion:^(BOOL finished) {

        self.frame = CGRectMake(0, BXScreenH, BXScreenW, BXScreenH);
    }];
...
-(void)configButtonClick
{
    ...
    if (self.delegate != nil && [self.delegate respondsToSelector:@selector(didClickFinishDateTimePickerView:SecID:Model:)]) {
        [self.delegate didClickFinishDateTimePickerView:_string SecID:self.secID Model:self.model];
    }
