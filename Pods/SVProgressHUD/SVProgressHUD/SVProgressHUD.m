...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        UIImage* errorImage = [UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"jinggao@3x" ofType:@"png"]];
...
- (void)updatePosition {
    ...
    CGFloat hudWidth = 150.0f;
    CGFloat hudHeight = 120.0f;
...
#pragma clang diagnostic pop
        ...
        if(hudHeight > 100.0f) {
            labelRect = CGRectMake(12.0f, labelRectY-10, hudWidth, stringHeight);
            hudWidth += 24.0f;
        } else {
            hudWidth += 24.0f;
            labelRect = CGRectMake(0.0f, labelRectY-10, hudWidth, stringHeight);
        }
    }
